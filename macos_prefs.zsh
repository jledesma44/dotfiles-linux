...
#sudo scutil --set ComputerName "Geesmini-M4"
#sudo scutil --set HostName "Geesmini-M4"
#sudo scutil --set LocalHostName "Geesmini-M4"
#sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Geesmini-M4"
...
# Removes all default apps from the dock
